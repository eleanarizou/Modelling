...
function [costF] = costFunsolveFun(NewRealradialAvgNuc,vec)
disp(vec)
%NewRealradialAvgNuc,
%% Modeling part
...
dapi = imread('/Users/elenirea/Documents/WarmflashWNTproject/WNT_turingfunction/outPutODE45_2020/dapiO.tif');
dapi = dapi > 30;
